    ...
    try {
        ...
        snapshot.forEach((document) => {
            ...
            <div class="card">
                ...
                <a 
                    class="btn"
                    href="https://wa.me/917733816532?text=Hello%20Ravi%20Ji,%20Mujhe%20${encodeURIComponent(product.name)}%20Order%20karni%20hai."
                    target="_blank"
                >
                    Order Now
                </a>
                ...
                <button
                    class="buy-btn"
                    onclick="buyNow(this,'${product.name}',${product.price})"
                >
                    ⚡ Buy Now
                </button>
